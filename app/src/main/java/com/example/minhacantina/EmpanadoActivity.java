...
public class EmpanadoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_empanado);
        ...
        prato1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                inserePrato("Coxinha de Frango", R.drawable.empcoxinha);
        ...
        prato2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                inserePrato("Risoles de Carne", R.drawable.emprisoles);
                trocaTela(ConfirmaActivity.class);
            }
        });
        ...
        prato3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String descricao = prato2.getText().toString();
                inserePrato("Bolinhas de Queijo", R.drawable.empbolinha);
                trocaTela(ConfirmaActivity.class);
            }
        });
        ...
        prato4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                inserePrato("Salsicha empanada", R.drawable.empsalsicha);
                trocaTela(ConfirmaActivity.class);
            }
        });
